...
public class AlterUtil {
	...
	public static void alterTable(Table table ,Connection connection,String database) throws Exception
    {
    	...
    	query.append(DDUtil.comQuery("ALTER TABLE",false,true,false));
    	query.append(DDUtil.comQuery(tableName,false,false,true));
		...
		for (Column column : columns)
		{
		    ...
		    query.append(DDUtil.comQuery("ADD COLUMN",false,true,false)+DDUtil.comQuery(name,false,true,false));
		    if (dataType == null)
		    {
		    ...
		    if (maxSize != null)
		    {
			query.append(DDUtil.comQuery("(" + maxSize + ")",false,true,false));
		    }
		    else
		    {
			query.append(" ");
		    ...
		    if (nullable != null)
		    {
			query.append(DDUtil.comQuery(nullable, false, true, false));
		    }
		    if (autoIncrement != null)
		    {
			query.append(DDUtil.comQuery(autoIncrement, false, true, false));
		    }
		    if (primaryKey != null)
		    {
			query.append(DDUtil.comQuery(primaryKey, false, true, false));
		    }
